...
class TransportResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return[
            ...
            'warehouse_start' => optional($this->warehouseStart)->name,
            'warehause_end_id' => $this->warehause_end_id,
            'warehouse_end' => optional($this->warehouseEnd)->name,
            'user_id' => $this->user_id,
            'user' => optional($this->user)->name,
            'date_emision' => $this->date_emision ? Carbon::parse($this->date_emision)->format("Y-m-d") : null,
            'state' => $this->state,
            'total' => $this->total,
            'impote' => $this->impote,
            'iva' => $this->iva,
