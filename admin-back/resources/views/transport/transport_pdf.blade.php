...
<div class="web-container">
            ...
            <table class="invoice-info-container">
                ...
                <tr>
                  <td style="font-size: small;">
                      Fecha Emisión: {{ $transport->date_emition_format }}
                  </td>
                </tr>
                <tr>
                  <td style="font-size: small;">
  ...
  <table class="invoice-info-container">
    ...
    <tr>
        <td>
           FECHA DE SALIDA: {{ $transport->date_exit_format }}
        </td>
        <td>
  ...
  <table class="invoice-info-container">
    ...
    <tr>
        <td>
           FECHA DE ENTREGA: {{ $transport->date_delivery_format }}
        </td>
        <td>
  ...
  <table class="line-items-container">
    ...
    <tbody>
      @foreach ($transport->transportDetails as $key => $item)
        <tr>
