...
onMounted(() => {
  id.value = props.clientSelected.id
  ...
  date_birthday.value = props.clientSelected.date_birthday
  gender.value = props.clientSelected.gender
  status.value = props.clientSelected.status
  id_department.value = props.clientSelected.id_department
  id_municipality.value = props.clientSelected.id_municipality
  id_district.value = props.clientSelected.id_district
  department.value = props.clientSelected.department
  municipality.value = props.clientSelected.municipality
  district.value = props.clientSelected.district
...
const update = async () => {
  ...
  try {
    const resp = await $api(`clients/${id.value}`, {
      method: 'PATCH',
      body: data,
      ...
      <VCardText class="pt-5">
        ...
        <VForm class="mt-4" @submit.prevent="update">
          <VRow>
            ...
            <VCol cols="3">
              <VSelect
                :items="[{ id: 1, name: 'Activo' }, { id: 2, name: 'inactivo' }]"
                placeholder="-- seleccione --"
                label="Estado"
                item-title="name"
                item-value="id"
